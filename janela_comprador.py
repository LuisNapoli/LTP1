...
class Janela_comprador(Toplevel):
    def __init__(self, parent, control):
        ...
        self.geometry('520x200+200+200')
        self.transient(parent)
        self.grab_set()

        Label(self, text='Dados do Comprador').grid(row=0, column=2, padx=20, pady=10)
        ...
        self.bt_remove = Button(self, text='Remover Comprador',fg='red',command=self.remove_comp). \
